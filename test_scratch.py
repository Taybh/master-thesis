...
if __name__ == '__main__':
    ...
    for num in num_samples:
        for org in origin:
            ...
            if org =='lc':
                model_dir = "logs/diff_seed_scratch" + str(num)+ "/lc/"
                model_name = 'unet_lc_Scratch'
                tar = 'R3'
            else:
                model_dir = "logs/diff_seed_scratch" + str(num)+ "/sn/"
                model_name = 'unet_sn_Scratch'
                tar = 'SN'

            # create results directory
            results_dir = 'EVAL_diff_seed_scratch' + str(num)+'_' +str(org) +'_' + 'to'+ '_'+str(tar)
